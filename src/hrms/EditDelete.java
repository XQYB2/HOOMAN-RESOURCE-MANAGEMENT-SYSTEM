...
public class EditDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Edit or Delete Employee's Informtion");
        ...
        jLabel2.setText("Edit or Delete Employee Record");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(Edit))
                            .addComponent(SearchID, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Delete))))
                .addGap(71, 71, 71)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(HireDate, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(MaritalStatus, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        ...
        try {
              ...
              EmployeeID = SearchID.getText();
               if("".equals(EmployeeID)){
                  ...
                  while (rs.next()){
                   notFound = 1;
                   String sql2 = "DELETE FROM employeeinfo WHERE EmployeeID = "+EmployeeID;
          ...
          try {
              ...
              if("".equals(EmployeeID)){
                  ...
                  while (rs.next()){
                   ...
                   HireDate.setDate(rs.getDate("HireDate"));
                   EmploymentStatus.setText(rs.getString("EmploymentStatus"));
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        int notFound = 0;
        String en, g, ms, n, cn, add, em, dp, es, EmployeeID;
              ...
              EmployeeID = SearchID.getText();
               if("".equals(EmployeeID)){
                  ...
                  while (rs.next()){
                   ...
                   String sql2 = "UPDATE employeeinfo SET EmployeeName ='"+en+"', DateOfBirth='"+dobStr+"', Gender='"+g+"', MaritalStatus='"+ms+"', "
                           + "Nationality='"+n+"', ContactNumber='"+cn+"', Address='"+add+"', Email='"+em+"', "
                           + "Department='"+dp+"', HireDate='"+hdStr+"', EmploymentStatus='"+es+"' WHERE EmployeeID = "+EmployeeID;

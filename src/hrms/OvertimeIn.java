 ...
 */
public class OvertimeIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Overtime Log In");
      ...
      java.util.Date sd;
       try{
         Class.forName("com.mysql.cj.jdbc.Driver");  
              ...
              JOptionPane.showMessageDialog(new JFrame(), "Overtime In is required","Dialog", JOptionPane.ERROR_MESSAGE);
              }
              ...
              JOptionPane.showMessageDialog(new JFrame(), "Date is required","Dialog", JOptionPane.ERROR_MESSAGE);
                  ...
                  query = "INSERT INTO attendance (EmployeeID, OvertimeIn,Date)"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OvertimeIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OvertimeIn().setVisible(true);
            }
        });
    }
